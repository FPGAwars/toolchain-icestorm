# Archived!
* **2022-May-9**: This repo has been archived, since the icestorm is no longer used as an isolated Apio package. Use the [Tools-oss-cad-suite](https://github.com/FPGAwars/tools-oss-cad-suite) package instead
